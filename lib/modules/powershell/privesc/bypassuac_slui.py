...
class Module:
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.options = {
            ...
            'Agent' : {
                'Description'   :   'The Agent to be executed on!',
                'Required'      :   True,
                'Value'         :   'default'
            },
            'command' : {
                'Description'   :   'This is the Payload Command to be Executed in Full Paths!',
                'Required'      :   True,
                'Value'         :   'default'
            }
        }
