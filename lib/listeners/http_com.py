...
class Listener:
    ...
    def default_response(self):
        ...
        page = ''
        with open("%s/data/misc/default.html" % (self.mainMenu.installPath)) as f:
            page = f.read()
        return '\n'.join([page, ' ' * self.header_offset])
    ...
    def index_page(self):
        ...
        page = ''
        with open("%s/data/misc/index.html" % (self.mainMenu.installPath)) as f:
            page = f.read()
        return '\n'.join([page, ' ' * self.header_offset])
