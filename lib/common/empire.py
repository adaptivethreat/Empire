...
class AgentMenu(cmd.Cmd):
    ...
    def __init__(self, mainMenu, sessionID):
        ...
        self.agentCommands = ["ls","dir","rm","del","cp","copy","pwd","cat","cd","mkdir","rmdir","mv","move","ipconfig","ifconfig","route","reboot","restart","shutdown","ps","tasklist","getpid","whoami","getuid","hostname","switch","sget","skill","sadd","sinfo","sfix","srandom","askcreds","start-process"]
