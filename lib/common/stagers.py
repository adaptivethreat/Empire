...
"""
        ...
        p.write(pkginfo)
        p.close()
        os.system(self.mainMenu.installPath+"bin/mkbom -u 0 -g 80 root expand/Bom")
        os.system("chmod +x expand/Bom")
        os.system("chmod -R 755 expand/")
        os.system('( cd expand && '+self.mainMenu.installPath+'bin/xar --compression none -cf "../launcher.pkg" * )')
